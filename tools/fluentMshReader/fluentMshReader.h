/* Read Fluent *.msh file and output a corresponding *.obj file.
 * argument: msh filename; boolean N1neighbor (decide whether to output
 *           N1neighbors in a separate file. 
 */


/* Fluent Mesh file format: 
 *
 */
#ifndef FLUENTMSHREADER_H
#define FLUENTMSHREADER_H
